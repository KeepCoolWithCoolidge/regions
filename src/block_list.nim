...
proc first_fit*(block_size: RSize; data_size: RSize; data_start: pointer): pointer
...
proc add_block*(block_size: RSize; list_top: ptr block_node;
               data_size: RSize; data_start: pointer): ptr block_node =
...
proc first_fit*(block_size: RSize; data_size: RSize;
